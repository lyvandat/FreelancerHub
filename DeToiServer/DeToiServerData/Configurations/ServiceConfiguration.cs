    ...
    internal class ServiceCategoryConfiguration : EntityTypeConfigurationBaseClass<ServiceCategory>
    {
        protected override void OnConfigure(EntityTypeBuilder<ServiceCategory> builder)
        {
            builder.HasData(
                ...
                {
                    new ServiceCategory { Id = new Guid("d17ad87c-9f80-4f0e-bfd4-53138d900a6e"), Name = "Dọn dẹp", Description = "Bao gồm lau nhà, quét nhà, hút bụi, và nhiều dịch vụ khác", Image = "https://detoivn.sirv.com/services/dondep/category.png" },
