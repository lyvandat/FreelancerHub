...
namespace DeToiServerData.Migrations
{
    ...
    [Migration("20240309065740_V1.6.2_UpdateDeleteBehaviorForOrderAndServiceType")]
    partial class V162_UpdateDeleteBehaviorForOrderAndServiceType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Services.ServiceStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("2274772b-0c34-4760-8ace-ae4044c57b6a"),
                            Name = "Đã tiếp nhận"
                        },
                        new
                        {
                            Id = new Guid("e1dd2e24-92e7-4d3e-900e-96d9bd123952"),
                            Name = "Đã hoàn thành"
                        });
                });
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Services.ServiceType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("9e45290b-e276-4306-942b-fba7353e13f5"),
                            BasePrice = 40000.0,
                        ...
                        new
                        {
                            Id = new Guid("9e09b1f3-4b3c-4c5b-a793-f34b9b014c7f"),
                            BasePrice = 50000.0,
                            Description = "Mua sắm hộ siêu nhanh",
                            Name = "Đi siêu thị hộ",
                            ServiceCategoryId = new Guid("6f57d993-eb26-4b35-8c7d-7871a7fd624f")
                        ...
                        new
                        {
                            Id = new Guid("893cf9cd-8e51-49c4-bf3a-36feb7967080"),
                            BasePrice = 100000.0,
                            Description = "Mua sắm hộ siêu nhanh",
                        ...
                        new
                        {
                            Id = new Guid("24dd4960-f1d5-4d3d-b54d-1350236f9abe"),
                            BasePrice = 60000.0,
                            Description = "Mua sắm hộ siêu nhanh",
                            Name = "Đi mua quần áo",
                            ServiceCategoryId = new Guid("6f57d993-eb26-4b35-8c7d-7871a7fd624f")
                        ...
                        new
                        {
                            Id = new Guid("1af7ad25-f0d8-40ab-85bb-b81fd34d7178"),
                            BasePrice = 300000.0,
                            Description = "Mua sắm hộ siêu nhanh",
                        ...
                        new
                        {
                            Id = new Guid("6e135fa2-e812-4b9a-8e0f-a4c7be6fe710"),
                            BasePrice = 4000000.0,
                            Description = "Mua sắm hộ siêu nhanh",
                        ...
                        new
                        {
                            Id = new Guid("b39dcf27-8be4-43fd-a139-9fc18f12ab63"),
                            BasePrice = 20000.0,
                            Description = "Mua sắm hộ siêu nhanh",
                        ...
                        new
                        {
                            Id = new Guid("0fcd6144-727c-48e8-88ee-3cee76e5bffc"),
                            BasePrice = 200000.0,
                        ...
                        new
                        {
                            Id = new Guid("23d025ca-3e57-4e10-a35d-6dd89b8e30a8"),
                            BasePrice = 200000.0,
                        ...
                        new
                        {
                            Id = new Guid("ca3301a2-d220-44f4-a02d-fc4e591c02df"),
                            BasePrice = 200000.0,
                            Description = "Sửa chữa để tôi lo",
                            Name = "Sửa bàn ủi",
                            ServiceCategoryId = new Guid("8a21b21e-dc31-49c8-8b5b-84b69204dc3a")
                        ...
                        new
                        {
                            Id = new Guid("16438f98-2bb0-45f9-a55f-1756802440c7"),
                            BasePrice = 200000.0,
                            Description = "Sửa chữa để tôi lo",
                            Name = "Sửa tivi",
                            ServiceCategoryId = new Guid("8a21b21e-dc31-49c8-8b5b-84b69204dc3a")
                        ...
                        new
                        {
                            Id = new Guid("11622e75-904f-48d3-96d7-9d79f3cdfb35"),
                            BasePrice = 200000.0,
                            Description = "Sửa chữa để tôi lo",
                            Name = "Sửa ống nước",
                            ServiceCategoryId = new Guid("8a21b21e-dc31-49c8-8b5b-84b69204dc3a")
                        ...
                        new
                        {
                            Id = new Guid("35ffdc5f-6693-4947-8228-3de859c13fbd"),
                        ...
                        new
                        {
                            Id = new Guid("bb45a26e-8f06-4d10-b8bc-460cae162c76"),
                            BasePrice = 200000.0,
                            Description = "Hãy yên tâm không nổ đâu",
            ...
            modelBuilder.Entity("DeToiServerCore.Models.SevicesUIElement.UIElementAdditionServiceRequirement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("41899b80-8d8c-42ba-ba04-290a533dcb52"),
                            AutoSelect = true,
                            Icon = "faDog",
                            Key = "hasPets",
                        ...
                        new
                        {
                            Id = new Guid("9dbfb4d0-c317-4be9-b7b3-f2351caaaec3"),
                            AutoSelect = false,
                            Icon = "faComputer",
                            Key = "hasElectronics",
                        ...
                        new
                        {
                            Id = new Guid("e60b683d-7bcb-4276-8eaf-4f925dfb14d4"),
                            AutoSelect = false,
                            Icon = "faBroom",
            ...
            modelBuilder.Entity("DeToiServerCore.Models.SevicesUIElement.UIElementInputOption", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fc018129-957c-4865-a265-6435ca52e05d"),
                        ...
                        new
                        {
                            Id = new Guid("61a2cd2d-406f-4ff9-86be-593ed58e7d28"),
            ...
            modelBuilder.Entity("DeToiServerCore.Models.SevicesUIElement.UIElementServiceRequirement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8d0f55c2-0ce2-441c-a2ff-60aba82b8ffc"),
                        ...
                        new
                        {
                            Id = new Guid("a3206feb-3c4c-4914-9aa5-ce7760d1cec5"),
                        ...
                        new
                        {
                            Id = new Guid("b2166c0b-62a3-4c31-9a4a-2471a6f8684b"),
            ...
            modelBuilder.Entity("DeToiServerCore.Models.SevicesUIElement.UIElementValidationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("29dd13f2-9f66-4fb4-a245-0953e2b5a5f6"),
                            InputMethodId = new Guid("95b69f6f-c8a5-4b94-824b-214bb7435c4f"),
                        ...
                        new
                        {
                            Id = new Guid("cd380bde-80c8-4f22-8069-b05d188b51ca"),
                            InputMethodId = new Guid("95b69f6f-c8a5-4b94-824b-214bb7435c4f"),
                        ...
                        new
                        {
                            Id = new Guid("7391d03b-005f-4bc0-9d18-c76849acb423"),
                            InputMethodId = new Guid("95b69f6f-c8a5-4b94-824b-214bb7435c4f"),
                        ...
                        new
                        {
                            Id = new Guid("38e705f5-06de-4745-94cc-5b1e32436068"),
                            InputMethodId = new Guid("0ad2fdde-73c5-433c-99f8-95e9c9df32a4"),
                        ...
                        new
                        {
                            Id = new Guid("9475d0fe-ad70-441c-a900-3ab8c8461f72"),
                            InputMethodId = new Guid("42b3fce8-5392-4bfd-97a2-0b84532a4b67"),
                        ...
                        new
                        {
                            Id = new Guid("d6fbff5b-8a91-4ec6-b4e3-a9da27652883"),
                            InputMethodId = new Guid("42b3fce8-5392-4bfd-97a2-0b84532a4b67"),
                        ...
                        new
                        {
                            Id = new Guid("2a09ff77-0a73-4df8-8a7c-ab997eb22e9c"),
                            InputMethodId = new Guid("42b3fce8-5392-4bfd-97a2-0b84532a4b67"),
