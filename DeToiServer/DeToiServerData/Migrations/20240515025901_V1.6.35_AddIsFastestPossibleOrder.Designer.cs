...
namespace DeToiServerData.Migrations
{
    ...
    [Migration("20240515025901_V1.6.35_AddIsFastestPossibleOrder")]
    partial class V1635_AddIsFastestPossibleOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Accounts.Account", b =>
                {
                    ...
                    b.Property<string>("EncriptingToken")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Accounts.AdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Chat.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Notifications.Notification", b =>
                {
                    ...
                    b.Property<string>("PushSound")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PushSubTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Order", b =>
                {
                    ...
                    b.Property<string>("FreelancerFaceImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsCustomerRated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsFastestPossible")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DeToiServerCore.Models.OrderAddress", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Payment.Fee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4165cef1-7486-45d6-9ce1-677dc35956d5"),
                            Amount = 0.050000000000000003,
                            Type = "Platform"
                        },
                        new
                        {
                            Id = new Guid("3e85a38f-21e3-43e8-9ecb-1d697a9cebf1"),
                            Amount = 50000.0,
                            Type = "MinServicePrice"
                        });
                });
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Reports.ReportImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Services.ServiceStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("083cdec1-ae32-475e-8c64-62599d6fe6c1"),
                            Icon = "faTruckFast",
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Chat.Message", b =>
                {
                    b.HasOne("DeToiServerCore.Models.Accounts.Account", "Receiver")
                        .WithMany("ReceivedMessage")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("DeToiServerCore.Models.Accounts.Account", "Sender")
            ...
            modelBuilder.Entity("DeToiServerCore.Models.Reports.ReportImage", b =>
                {
                    b.HasOne("DeToiServerCore.Models.Reports.Report", "Report")
                        .WithMany("Images")
